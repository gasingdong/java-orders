...
public class SeedData implements CommandLineRunner
{
    ...
    public SeedData(CustomersRepository custrepos, AgentsRepository agentsrepos, OrdersRepository ordersrepos)
    {
        this.custrepos = custrepos;
        this.agentsrepos = agentsrepos;
    ...
    public void run(String... args) throws Exception
    {
        ...
        agentsrepos.save(a01);
        agentsrepos.save(a02);
        agentsrepos.save(a03);
        agentsrepos.save(a04);
        agentsrepos.save(a05);
        agentsrepos.save(a06);
        agentsrepos.save(a07);
        agentsrepos.save(a08);
        agentsrepos.save(a09);
        agentsrepos.save(a10);
        agentsrepos.save(a11);
        agentsrepos.save(a12);
